...
public class A_VirusStateMachine : StateManager<A_VirusStateMachine.EState>
{
    ...
    private void Awake()
    {
        ...
        states.Add(EState.Jump, new A_VirusJumpState(EState.Jump, movement));
        states.Add(EState.Track, new A_VirusTrackTargetState(EState.Track, pathFinder, movement, targetMask, detectionRadius));
